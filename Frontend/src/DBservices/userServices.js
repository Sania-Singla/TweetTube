export class UserServices {
    async registerUser(inputs, setData, setLoading) {
        ...
        try {
            ...
            if (res.ok) {
                //true
                return this.loginUser(setData, setLoading, {
                    loginInput: inputs.username,
                    password: inputs.password,
                }); //could send inputs.email also any one is fine
    ...
    async updateAccountDetails(inputs) {
        try {
            ...
            return console.log(
                'error in updateAccountDetails service',
                err.message
            );
        }
    }
    ...
    async updateCoverImage(coverImage) {
        try {
            ...
            return console.log(
                'error in updateCoverImage service',
                err.message
            );
        }
    }
