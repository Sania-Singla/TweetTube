...
function ChannelAbout() {
    ...
    useEffect(()=>{
      setLoading(true);
      channelServices.getChannelAbout(setLoading,channelData._id)
      .then(Data => {
        ...
        <div className='w-full py-3 px-12'>
          ...
          <div className='w-full mt-5'>
            ...
            <p className='flex items-center mb-2 gap-3 text-[1.1rem]'>
              ...
              <NavLink className="text-blue-500 pb-1" to={`/channel/${aboutData.username}`}>{`https://tweettube/channel/${aboutData.username}`}</NavLink>
            </p>
            <p className='flex items-center mb-2 gap-3 text-[1.1rem]'>
