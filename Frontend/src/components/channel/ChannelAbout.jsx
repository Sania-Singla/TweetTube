...
function ChannelAbout() {
    ...
    useEffect(() => {
        setLoading(true);
        channelServices
            .getChannelAbout(setLoading, channelData._id)
            .then((Data) => {
                if (Data.message === 'CHANNEL_NOT_FOUND')
                    navigate('/'); // navigate to 404not found page ⭐⭐⭐
    ...
    if (loading) return <PulseChannelAbout />;
        ...
        return (
            <div className="w-full py-3 px-12">
                ...
                <div className="text-[1.1rem] text-gray-100 mt-4">
                ...
                <div className="w-full mt-5">
                    <p className="flex items-center mb-2 gap-3 text-[1.1rem]">
                        ...
                        <NavLink className="text-blue-500 pb-1">
                            {aboutData.email}
                        </NavLink>
                    </p>
                    <p className="flex items-center mb-2 gap-3 text-[1.1rem]">
