    ...
    return (
        <div className="p-4 bg-[#13161f] backdrop-blur-sm border-[0.01rem] border-[#757575] border-dotted rounded-md shadow-black shadow-md w-[500px]">
            <div className="flex items-start justify-start w-full">
                ...
                <div className="ml-3 ">
                    <h2 className="text-[1.3rem] font-medium">Confirm deleting this Playlist?</h2>
                    <h2 className="text-[0.9rem] text-[#b5b4b4] font-medium">Note: The videos within the playlist won't be deleted.</h2>
                </div>
