                ...
                if (allowedExtensions.includes(extension)) {
                    if (fileSize > maxSizeMB)
                        return setError((prevError) => ({
                            ...prevError,
                            root: 'File is too large, Please upload a file smaller than 100MB.',
                        }));
    ...
    const handleBlur = (e) => {
        ...
        if (name === 'description') {
            ...
            !files[0] &&
                setError((prevError) => ({
                    ...prevError,
                    videoFile: 'videoFile is required.',
                }));
        }
    };
            ...
            <form onSubmit={handleUploadVideo} className="w-full p-4">
                ...
                <div className="p-6 border-dashed border-[0.1rem] border-[#d4d4d4] w-full flex flex-col items-center justify-center">
                    <div className="p-[10px] bg-[#E4D3FF] overflow-hidden rounded-full">
                        <div className="size-[25px] stroke-[#8871ee] fill-none ">
                            {icons.downloadPopup}
                        </div>
                    </div>
                    ...
                    <div className="text-[0.9rem] mt-1 font-medium text-[#898989]">
