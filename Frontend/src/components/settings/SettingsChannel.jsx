...
export default function SettingsChannel() {
    ...
    return (
        <div className="w-full h-full bg-[#0c0c0c] flex flex-col p-3 sm:flex-row sm:justify-between gap-4">
            ...
            <form onSubmit={handleSubmit} className="w-full sm:min-w-[40%] sm:max-w-[60%] lg:max-w-[70%] mt-2 sm:mt-0 p-5 border-[0.01rem] border-[#b5b4b4] rounded-[10px] relative">
                ...
                <div className="flex items-center justify-end mt-5 gap-5 w-full">
                    ...
                    <button type="submit" className="bg-[#8871ee] border-[0.01rem] text-[#0c0c0c] border-[#b5b4b4] border-dotted py-[3.2px] px-2 text-lg">Save changes</button>
                </div>
            </form>
        </div>
    )
