        ...
        >
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="leading-[21px]">
                    <div className="text-[1.2rem] mt-2 font-medium line-clamp-2 leading-[26px] text-[#f4f4f4]">
                        {title}
                    </div>
                    <div className="text-[#c6c6c6] text-[1.06rem] mt-[3px]">
                        {fullname}
                    </div>
                    <div className=" text-[#c6c6c6] text-[0.9rem]">
