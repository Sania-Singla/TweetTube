            ...
            <div className='mt-6 text-center'>
                <div className='mb-2 flex items-center justify-start'>
                    ...
                    <div>
                        ...
                        <NavLink to={"https://www.linkedin.com/in/sania-singla/"} className="text-blue-500 text-[0.9rem]">/sania-singla</NavLink>
                    </div>
                </div>
                ...
                <div className='mb-2 flex items-center justify-start'>
                    ...
                    <div>
                        ...
                        <NavLink to={"https://github.com/Sania-Singla"} className="text-blue-500 text-[0.9rem]">/Sania-Singla</NavLink>
                    </div>
                </div>
                <div className='mb-2 flex items-center justify-start'>
                    <div className='size-[35px] mr-5'>{icons.link}</div>
                    <div>
                        ...
                        <NavLink to={"https://x.com/sania_singla"} className="text-blue-500 text-[0.9rem]">/sania_singla</NavLink>
                    </div>
                </div>
                <div className='mb-2 flex items-center justify-start'>
                    <div className='size-[35px] mr-5'>{icons.link}</div>
                    <div>
                        ...
                        <NavLink to={"https://discord.com/channels/@sania_singla"} className="text-blue-500 text-[0.9rem]">@sania_singla</NavLink>
                    </div>
                </div>
            </div>
        </div>
