...
function LikedVideos() {
  ...
  async function removeFromLikedVideos(id) {   //call toggle like method
  ...
  useEffect(()=>{
    if(loginStatus)
    {
      if(!likedInfo.totalVideos || likedVideos.length !== likedInfo.totalVideos) 
      {
        ...
        channelServices.getLikedVideos(setLikedVideos,setLoading,setLikedInfo,likedVideos,page,search,10)
        .then(data=>{
    ...
    if(!videosFound) return <div className='text-white'>no liked videos</div> 
        ...
        <div>
            <div className="w-full h-full ">
              <div className="bg-[#0c0c0c] mb-8 flex items-center justify-center">   {/*sticky top-[calc(80px-0.01rem)] z-[120]*/}
...

          {
            ...
            <div className="flex items-center justify-center my-2">
              <svg aria-hidden="true" class="inline w-7 h-7 animate-spin dark:text-[#b5b4b4] fill-[#8871ee]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
