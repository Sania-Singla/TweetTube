    ...
    return (
        <div className="flex flex-col items-center pt-[60px]">
            <div className="bg-[#e3d0fd] rounded-full w-fit p-[3px]">
                <div className="size-[145px] brightness-125 text-[#6d50ec]">
                    {icons.support}
                </div>
            </div>
            <div className="mt-6 text-[1.6rem] font-semibold">
            ...
            <div className="mt-6 text-center">
                <div className="mb-2 flex items-center justify-start">
                    ...
                    <div>
                        ...
                        <NavLink
                            to={'https://www.linkedin.com/in/sania-singla/'}
                            className="text-blue-500 text-[0.9rem]"
                        >
                            /sania-singla
                        </NavLink>
                    </div>
                ...
                <div className="mb-2 flex items-center justify-start">
                    ...
                    <div>
                        ...
                        <NavLink
                            to={'https://github.com/Sania-Singla'}
                            className="text-blue-500 text-[0.9rem]"
                        >
                            /Sania-Singla
                        </NavLink>
