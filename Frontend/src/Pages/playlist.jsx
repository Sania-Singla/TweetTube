        ...
        return (
            ...
            >
                ...
                <div className="hidden sm:block ml-2 mt-1 pr-10 sm:mt-0 sm:ml-3 max-w-[200px] md:max-w-[50%] lg:max-w-[55%]">
                    <div className="mb-3 text-[1.3rem] font-medium text-white line-clamp-2">{title}</div>
                    ...
                    <div className="text-[15.5px] text-[#b0afaf] line-clamp-1 mt-[5px] leading-5">{description}</div>
        ...
        <div className="">
            ...
            {!loading && data.createdAt && (
                <div className="flex flex-col xl:flex-row gap-y-[40px] gap-x-[30px]">
                        ...
                        <div className="sm:w-[450px]">
                                    ...
                                    <div className="px-2 py-1 min-h-[70px] flex items-start justify-between absolute inset-x-0 bottom-0 border-t-[0.01rem] border-[#b5b4b4] bg-slate-950 bg-opacity-80 backdrop-blur-sm ">
                                        <div className="w-[70%]">
                                            ...
                                            <div className="text-[#b5b4b4] text-[0.9rem]">
                                                {views} Views &bull; {formatDistanceToNow(parseISO(data.createdAt), { addSuffix: true })}{" "}
                                            </div>
                                        </div>
                            ...
                            {userData && userData._id === data.createdBy._id && (
                                <div className="w-full flex items-center justify-around px-12 mt-4">
                                    <button
                                        onClick={() => setDeletePlaylistPopup(true)}
                                    ...
                                    <button
                                        onClick={() => setEditPlaylistPopup(true)}
                            ...
                            <div className="mt-3">
                                ...
                                <div
                                    onClick={() => navigate(`/channel/${data.createdBy.username}`)}
                    ...
                    <div className="w-full">{data.totalVideos ? videoElements : <div>empty Playlist</div>}</div>
                </div>
            )}
            {editPlaylistPopup && (
