           ...
           <div className="flex flex-col items-center justify-center py-[50px]">
                <div className="flex flex-col items-center justify-center w-full">
                    <div className='w-[50px] h-[50px] rounded-full overflow-hidden'>
                        <Link to="/"><img src="/sunflower.jpg" alt="logo" /></Link>
                    </div>
                    <h2 className="font-semibold text-[1.65rem] mt-5">CREATE ACCOUNT</h2>
                    <h3 className="text-lg mt-1">Already have an Account ?<Link to="/login" className="text-[1rem] text-blue-700"> Login now</Link></h3>
