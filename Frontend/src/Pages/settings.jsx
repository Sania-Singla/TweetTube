    ...
    const optionsElements = options.map((option) => (
        <div key={option.name} className="flex items-center justify-center w-1/3 mx-[3px]">
            <NavLink
                ...
                className={({ isActive }) =>
                    `${
                        isActive ? "bg-white font-semibold border-b-[0.13rem] border-[#8871ee] text-[#0c0c0c]" : "text-[#ffffff]"
        ...
        return (
            <div className="text-white relative">
                <div className="w-full relative">
                    ...
                    <input ref={coverImageRef} type="file" name="coverImage" id="coverImage" className="hidden" onChange={handleFileChange} />
                    <button
                ...
                <div className="relative top-[-15px] flex items-center ml-1">
                    <div className="relative w-[100px] h-[100px] sm:w-[130px] sm:h-[130px] overflow-hidden rounded-full border-2 border-[#b5b4b4]">
                        ...
                        <input ref={avatarRef} type="file" id="avatar" name="avatar" className="hidden" onChange={handleFileChange} />
                        <button
                            onClick={avatarInput}
                ...
                <div className="flex items-center justify-evenly w-full mb-[6px]">{optionsElements}</div>
