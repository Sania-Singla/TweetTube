...
import { Subscription, Video } from '../models/index.js';
...
const getStats = async (req, res) => {
    ...
    try {
        ...
        return res.status(SERVER_ERROR).json({
            message: 'something bad happened while fetching the channel stats.',
            err: err.message,
        });
    }
};
...
const getVideos = async (req, res) => {
    ...
    try {
        ...
        return res.status(SERVER_ERROR).json({
            message:
                'something went wrong while fetching channel videos for admin page',
            err: err.message,
        });
    }
};

export { getStats, getVideos };
